...
package struct Opentelemetry_Proto_Collector_Profiles_V1development_ExportProfilesPartialSuccess: Sendable {
  ...
  package var rejectedProfiles: Int64 = 0
...
extension Opentelemetry_Proto_Collector_Profiles_V1development_ExportProfilesServiceRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".ExportProfilesServiceRequest"
  ...
  package static func ==(lhs: Opentelemetry_Proto_Collector_Profiles_V1development_ExportProfilesServiceRequest, rhs: Opentelemetry_Proto_Collector_Profiles_V1development_ExportProfilesServiceRequest) -> Bool {
...
extension Opentelemetry_Proto_Collector_Profiles_V1development_ExportProfilesServiceResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".ExportProfilesServiceResponse"
  ...
  package static func ==(lhs: Opentelemetry_Proto_Collector_Profiles_V1development_ExportProfilesServiceResponse, rhs: Opentelemetry_Proto_Collector_Profiles_V1development_ExportProfilesServiceResponse) -> Bool {
...
extension Opentelemetry_Proto_Collector_Profiles_V1development_ExportProfilesPartialSuccess: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".ExportProfilesPartialSuccess"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}rejected_profiles\0\u{3}error_message\0")
  ...
  package static func ==(lhs: Opentelemetry_Proto_Collector_Profiles_V1development_ExportProfilesPartialSuccess, rhs: Opentelemetry_Proto_Collector_Profiles_V1development_ExportProfilesPartialSuccess) -> Bool {
