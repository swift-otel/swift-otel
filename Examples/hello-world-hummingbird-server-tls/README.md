# Hello World HTTP server with observability middleware (OTLP/HTTP + TLS)
...
Telemetry data is exported using OTLP/HTTP+Protobuf, with TLS verification.
